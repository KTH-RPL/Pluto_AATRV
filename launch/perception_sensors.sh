...
# xterm -T "Perception Rosbag" -geometry 80x15+0+ -e "rosbag record -b 0 /rsD455_node0/color/image_raw /rsD455_node0/depth/image_rect_raw /ouster/points /ouster/points2 /atrv/odom /atrv/cmd_vel /clock /reach/fix /vectornav/Odom /vectornav/INS /tf /tf_static" & sleep 1
