...
def execute_planning(start, goal):
    global robot_radius
...
# -------- SAMPLE USAGE --------------------
# from local_planner_func import execute_planning
# path, _, _, _ = execute_planning(start, goal) #obstacle is the function from Rajesh's code
